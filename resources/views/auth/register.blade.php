...
<div class="container">
    <div class="register__page-block d-flex flex-column gap-3 align-items-center justify-content-center">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="role" class="col-md-4 col-form-label text-md-end">{{ __('Роль в программе') }}</label>

                            <div class="col-md-6">
                                <select id="role" name="role" class="form-control" required>
                                    <option value="admin">Администратор</option>
                                    <option value="responsible">Ответственный группы руководителей проектов</option>
                                    <option value="proj_manager">Руководитель проектов</option>
                                </select>
                            </div>
                        </div>
